            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const onScanSuccess = (decodedText, decodedResult) => {
                    ...
                    html5QrcodeScanner.clear().then(_ => {
                        const checkUrlRoute = "{{ route('scan.pinjamBarang.checkId', ':id') }}"; //route untuk mengecek ID booking/peminjaman
                        ...
                        $.ajax({
                            ...
                            .done(function(data) {
                                ...
                                if (data.exists) {  // Jika ID booking/peminjaman ada
                                    ...
                                    const finalUrl = "{{ route('admin.peminjaman.ubah', ':id') }}".replace(':id', decodedText);
