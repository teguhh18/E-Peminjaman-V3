        ...
        @foreach ($dataBooking as $booking)
            <tr class="odd gradeX ">
                ...
                <td>
                    ...
                    @if (in_array($booking->status_peminjaman, ['disetujui', 'aktif']))
                ...
                <td>
                    @if ($booking->ruangan != null)
                        ...
                        @if (in_array($booking->status_peminjaman, ['disetujui', 'aktif', 'selesai']))
                            <div class="mt-1">
                                <span class="btn badge bg-primary text-light" id="btn-status-ruangan"
                                    data-id="{{ $booking->id }}">
                                    Status:
                ...
                <td>
                    @foreach ($booking->persetujuan_peminjaman as $persetujuan)
                        ...
                        @endphp
                        @if ($persetujuan->approval_role === 'baak')
