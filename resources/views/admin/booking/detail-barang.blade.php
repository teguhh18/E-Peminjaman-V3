                                ...
                                @foreach ($detailPeminjaman as $detail)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            Unit Kerja : {{ $detail->barang->ruangan->unitkerja->kode }}
                                        </td>
                                        <td>
                                            ...
                                            @php
                                                ...
                                                if ($user->level === 'admin') {
                                                    ...
                                                    $user->level === 'baak' &&
                                                    $user->unitkerja_id == $detail->barang->unitkerja_id
                                                ) {
                                                    $isMyApproval = true;
                                                }
                                            @endphp
                                            ...
                                            @if ($isMyApproval && $detail->peminjaman->status_peminjaman != 'menunggu')
                                                <span
                                                    class="btn badge {{ $bg }} d-inline-block mb-1 text-light"
                                                    id="btn-status-barang" data-id="{{ $detail->id }}">
                                                    <i class="{{ $icon }}"></i>
