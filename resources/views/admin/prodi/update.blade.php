    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <form action="{{ route('admin.prodi.update', $prodi->id) }}" method="POST" class="form-horizontal"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 @error('kode_prodi') has-error @enderror">
                                <label for="kode_prodi" class="form-label">Kode_prodi Prodi</label>
                                <input type="text" class="form-control" id="kode_prodi" name="kode_prodi"
                                    placeholder="Kode_prodi Prodi" value="{{ old('kode_prodi', $prodi->kode_prodi) }}">
                                @error('kode_prodi')
                            ...
                            <div class="col-md-6  @error('nama') has-error @enderror">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama"
                                    placeholder="Nama Unit Kerja" value="{{ old('nama', $prodi->nama) }}" required>
                                @error('nama')
                                    <small class="form-message">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <select name="unitkerja_id" id="unitkerja_id"
                                    ...
                                    @foreach ($unit as $uk)
                                        <option value="{{ $uk->id }}"
                                            {{ old('unitkerja_id', $prodi->unitkerja_id) == $uk->id ? 'selected' : '' }}>
                                            {{ $uk->kode }} - {{ $uk->nama }}
                                        </option>
                                    @endforeach
                                </select>
