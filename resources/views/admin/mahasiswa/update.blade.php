            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('admin.mahasiswa.index') }}" class="btn btn-xs btn-warning btn-add">
                            <i class="fa fa-arrow-left"></i> Kembali
                        </a>
                    </div>
                </div>
                <form action="{{ route('admin.mahasiswa.update', $mahasiswa->id) }}" method="POST" class="form-horizontal"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control @error('name') has-error @enderror" id="name"
                                    name="name" placeholder="Nama User" value="{{ old('name', $mahasiswa->name) }}"
                                    required>
                                @error('name')
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <input type="text" class="form-control @error('username') has-error @enderror"
                                    id="username" name="username" placeholder="Username User"
                                    value="{{ old('username', $mahasiswa->username) }}" disabled>
                                @error('username')
                                    <small class="invalid-feedback">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" class="form-control @error('no_telepon') has-error @enderror"
                                    ...
                                    value="{{ old('no_telepon', $mahasiswa->no_telepon) }}" maxlength="13">
                            ...
                            <div class="col-md-6 mb-2 " id="units">
                                ...
                                <select name="unitkerja_id" id="unitkerja_id"
                                    class="form-control @error('unitkerja_id') has-error @enderror">
                                    <option value="">- Pilih Unit Kerja -</option>
                                    @foreach ($unitKerja as $unit)
                                        <option value="{{ $unit->id }}"
                                            {{ old('unitkerja_id', $mahasiswa->unitkerja_id) == $unit->id ? 'selected' : '' }}>
                                            {{ $unit->kode }} &nbsp; [{{ $unit->nama }}]
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                @enderror
                                <img src="{{ asset('storage/users/' . $mahasiswa->foto) }}" class="img-fluid mb-3"
                                    width="250px">
                                <br> Foto baru :
