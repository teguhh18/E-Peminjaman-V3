    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-orange text-orange-fg">
                <div class="modal-title">Hapus Data {{ $mahasiswa->name }}?</div><i class="fa fa-warning"></i>
            </div>

            <div class="modal-body">Klik Button Hapus untuk menghapus data.</div>
            <div class="modal-footer">
                <form method="post" action="{{ route('admin.mahasiswa.destroy', $mahasiswa->id) }}" id="idForm">
                    @csrf
                    @method('delete')
