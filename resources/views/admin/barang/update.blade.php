    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <form action="{{ route('admin.barang.update', $dataBarang->id) }}" method="POST" class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-6 mb-2 ">
                                ...
                                <select name="kategori_id" id="kategori_id"
                                    ...
                                    @foreach ($kategoris as $kat)
                                        <option value="{{ $kat->id }}"
                                            {{ $kat->id == old('kategori_id', $dataBarang->kategori_id) ? 'selected' : '' }}>
                                            {{ $kat->nama }}</option>
                                    @endforeach
                                </select>
                                @error('kategori_id')
                                    ...
                                    @foreach ($gedungs as $gedungNama => $ruanganGroup)
                                        <optgroup label="{{ $gedungNama }}">
                                            @foreach ($ruanganGroup as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ $row->id == old('ruangan_id', $dataBarang->ruangan_id) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <select name="unitkerja_id" id="unitkerja_id"
                                    ...
                                    @foreach ($unitkerjas as $uk)
                                        <option value="{{ $uk->id }}"
                                            {{ old('kondisi', $dataBarang->unitkerja_id) == $uk->id ? 'selected' : '' }}>
                                            {{ $uk->kode }} - {{ $uk->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <select name="kondisi" id="kondisi"
                                    ...
                                    <option value="2"
                                        {{ 2 == old('kondisi', $dataBarang->kondisi) ? 'selected' : '' }}>Rusak
                                        Berat</option>
                                    <option value="3"
                                        {{ 3 == old('kondisi', $dataBarang->kondisi) ? 'selected' : '' }}>Rusak
                                        Ringan</option>
                                </select>
                                @error('kondisi')
                                    <small class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <select name="bisa_pinjam" id="bisa_pinjam"
                                    ...
                                    <option value="0"
                                        {{ old('bisa_pinjam', $dataBarang->bisa_pinjam) == '0' ? 'selected' : '' }}>Tidak
                                    </option>
                                    <option value="1"
                                        {{ old('bisa_pinjam', $dataBarang->bisa_pinjam) == '1' ? 'selected' : '' }}>Bisa
                                    </option>
                                </select>
                                @error('bisa_pinjam')
                                    <small class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="2" {{ 2 == old('status', $dataBarang->status) ? 'selected' : '' }}>
                                        Dihapus
                                    </option>
                                    <option value="3" {{ 3 == old('status', $dataBarang->status) ? 'selected' : '' }}>
                                        Diperbaiki</option>
                                </select>
                                @error('status')
                                    <small class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                @enderror
                                {{-- <img src="{{ asset('storage/barangs/' . $dataBarang->foto) }}" class="img-fluid mb-3"
                                    width="250px"> --}}
                                <img src="{{ $dataBarang->foto ? asset('storage/barangs/' . $dataBarang->foto) : 'https://placehold.co/250x250?text=No+Image' }}"
                                    alt="Foto Barang {{ $dataBarang->nama }}" class="img-preview img-fluid mt-3">
