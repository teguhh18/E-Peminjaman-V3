                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control @error('name') has-error @enderror" id="name"
                                    name="name" placeholder="Nama User" value="{{ old('name') }}" required>
                                @error('name')
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <input type="text" class="form-control @error('username') has-error @enderror"
                                    id="username" name="username" placeholder="Username User" value="{{ old('username') }}"
                                    required>
                                @error('username')
                                    <small class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2 " id="units">
                                ...
                                <select name="unitkerja_id" id="unitkerja_id"
                                    ...
                                    @foreach ($unitKerja as $unit)
                                        <option value="{{ $unit->id }}">{{ $unit->kode }} || {{ $unit->nama }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('unitkerja_id')
